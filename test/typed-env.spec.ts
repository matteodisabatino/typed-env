...
test('Should return the version', t => {
  t.is(TypedEnv.version, manifest.version)
})
...
test('Should convert to Array', t => {
...
test('Should convert to BigUint64Array', t => {
...
test('Should convert to Date (from String)', t => {
  const toDate = env.get('TO_DATE_FROM_STRING', 'date')
  t.is(toDate instanceof Date, true)
  t.is(toDate.getTime(), 946681200000)
})

test('Should convert to Float32Array', t => {
...
test('Should convert to Float64Array', t => {
...
test('Should convert to Int16Array', t => {
...
test('Should convert to Int32Array', t => {
...
test('Should convert to Uint8ClampedArray', t => {
...
test('Should convert to Uint16Array', t => {
...
test('Should convert to Uint32Array', t => {
...
test('Should return Array default value', t => {
...
test('Should return BigInt default value', t => {
  const toBigInt = env.get('TO_BIG_INT_NOT_EXISTS', 'bigint', BigInt(99))
  t.is(typeof toBigInt, 'bigint')
  t.is(toBigInt, BigInt(99))
})

test('Should return BigInt64Array default value', t => {
...
test('Should return BigUint64Array default value', t => {
...
test('Should return Boolean default value', t => {
  const toBoolean = env.get('TO_BOOLEAN_NOT_EXISTS', 'boolean', true)
  t.is(typeof toBoolean, 'boolean')
  t.is(toBoolean, true)
})

test('Should return Date default value', t => {
...
test('Should return Float32Array default value', t => {
...
test('Should return Float64Array default value', t => {
...
test('Should return Function default value', t => {
...
test('Should return Int8Array default value', t => {
...
test('Should return Int16Array default value', t => {
...
test('Should return Int32Array default value', t => {
...
test('Should return Map default value', t => {
...
test('Should return Uint8ClampedArray default value', t => {
...
test('Should return Uint16Array default value', t => {
...
test('Should return Uint32Array default value', t => {
...
test('Should throw an exception because of unknown conversion type', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to BigInt', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to BigInt64Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to BigUint64Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to Boolean', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to Date', t => {
  t.throws(() => {
...
test('Should throw an exception because "[20,"bar"]" cannot be converted to Float32Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "[20,"bar"]" cannot be converted to Float64Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to Function', t => {
  t.throws(() => {
...
test('Should throw an exception because "[30,"baz"]" cannot be converted to Int8Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "[40,"foo"]" cannot be converted to Int16Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "[50,"bar"]" cannot be converted to Int32Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to Map', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to Object', t => {
  t.throws(() => {
...
test('Should throw an exception because "?:" cannot be converted to RegExp', t => {
  t.throws(() => {
...
test('Should throw an exception because "test" cannot be converted to Set', t => {
  t.throws(() => {
...
test('Should throw an exception because "[10,"foo"]" cannot be converted to Uint8Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "[50,"bar"]" cannot be converted to Uint8ClampedArray', t => {
  t.throws(() => {
...
test('Should throw an exception because "[250,"baz"]" cannot be converted to Uint16Array', t => {
  t.throws(() => {
...
test('Should throw an exception because "["foo",3400]" cannot be converted to Uint32Array', t => {
  t.throws(() => {
...
test('Should check key exists', t => {
  const exists = env.has('TO_STRING')
  t.is(exists, true)
})

test("Should check key doesn't exist", t => {
  const exists = env.has('NOT_EXISTS')
  t.is(exists, false)
})

test('Should return TO_NUMBER since is the firse existing key', t => {
  const toNumberStringed = env.first(['NOT_EXISTS', 'TO_NUMBER', 'TO_STRING'])
  t.is(toNumberStringed, '5')
})

test('Should return default value since no key exists', t => {
  const toNumber = env.first(['NOT_EXISTS', 'NOT_EXISTS_2', 'NOT_EXISTS_3'], 'number', 10)
  t.is(toNumber, 10)
})

test('Should return to TO_REG_EXP since the key exists', t => {
  const toRegExp = env.require('TO_REG_EXP', 'regexp')
  t.is(toRegExp instanceof RegExp, true)
  t.is(toRegExp.toString(), '/^hello$/')
})

test('Should return to TO_OBJECT since is the first key that exists', t => {
  const toObject = env.requireFirst(['TO_OBJECT', 'TO_MAP', 'TO_SET'], 'object')
  t.is(Object.prototype.toString.call(toObject), '[object Object]')
  t.deepEqual(toObject, { key: 'value' })
})

test('Should check that TO_UINT_32_ARRAY exists and return it as a string', t => {
  const { TO_UINT_32_ARRAY } = env.exists
  t.is(typeof TO_UINT_32_ARRAY, 'string')
  t.is(TO_UINT_32_ARRAY, '[1200,3400]')
})

test("Should throw an exception since TO_BIG_INT_NOT_EXISTS is required but it doesn't exist", t => {
  t.throws(() => {
